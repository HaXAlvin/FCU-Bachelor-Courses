...
void GPAB_IRQHandler(void)
{
    ...
    if (((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->ISRC & 0x00000001) {        
        ((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) ))->ISRC |= 0x00000001;			
			...
			if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((3)<<2))))==0) { (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((3)<<2))))=1; KEY_Flag =3;}
				if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2))))==0) { (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2))))=1; KEY_Flag =6;}
				if ((*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2))))==0) { (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2))))=1;KEY_Flag =9;}
				return;			
    } 
	...
	if(u32IntSts & (((((UART_T *) ((( uint32_t)0x40000000) + 0x50000)))->ISR & (1ul << 0))>>0)) 
  {
		...
		while (!(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 14))){ 
			...
			if (c!='\n') {        
				...
				for (i=0; i<comRbytes; i++)	 reading[i]=comRbuf[i]; 
  ...
  while(1){
    ...
    if (RX_Flag==1) {
			...
			if(len==4){
				...
				UART_Write(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), writing, 5);
