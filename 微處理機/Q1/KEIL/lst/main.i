    ...
    while(1) {
      ...
      u32ADCvalue = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(7)] & (0xFFFFul << 0));
			...
			if(ball_y==-1 && x>r && x<r+32 && y<16){
				ball_y = 1;
				PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), 0x0, 2000, 90); 
					PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40100000) + 0x40000)), (1UL));
			}
			...
			UART_Write(((UART_T *) ((( uint32_t)0x40000000) + 0x50000)), writing, 10);
			
			draw_Bmp32x8((u32ADCvalue/43),50,0xFFFF,0x0000,racket); 
			if(RX_Flag==1){
				r = (reading[0]-48)*100+(reading[1]-48)*10+(reading[2]-48)*1;
				RX_Flag=0;
			}
			draw_Bmp32x8(r,6,0xFFFF,0x0000,racket);	
			draw_Bmp8x8(x,y,0xFFFF,0x0000,ball);
